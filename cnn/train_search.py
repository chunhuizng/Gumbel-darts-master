...
parser.add_argument('--data', type=str, default='/home/grouplcheng/data/zch/dataset/cifar10/train',
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        # training
        train_acc, train_obj = train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, temperature)
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, temperature):
